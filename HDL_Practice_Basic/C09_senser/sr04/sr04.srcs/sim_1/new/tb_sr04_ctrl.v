...
module tb_sr04_ctrl ();
    ...
    task sr04();
        begin
            ...
            TIME_START = $time;
            wait (!trigger);
            $display("%t, \tTREAGER ==> start = %d, \tend = %d, \tlength = %d ns",
            ...
            #1;
            $display(
                "%t, \tset_Distance = %dcm, \tdist_sr04 = %d, \techo_time = %dus,\tus/58[echo_time] = %d",
                $time, set_Distance, dist_sr04, TIME_REG/1000, TIME_REG / 58000);
        end
    endtask
