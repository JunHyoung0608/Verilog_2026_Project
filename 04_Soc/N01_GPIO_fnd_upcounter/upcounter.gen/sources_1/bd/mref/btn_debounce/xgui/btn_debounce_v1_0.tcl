...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "F_COUNT" -parent ${Page_0}
...
proc update_PARAM_VALUE.F_COUNT { PARAM_VALUE.F_COUNT } {
	# Procedure called to update F_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.F_COUNT { PARAM_VALUE.F_COUNT } {
	# Procedure called to validate F_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.F_COUNT { MODELPARAM_VALUE.F_COUNT PARAM_VALUE.F_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.F_COUNT}] ${MODELPARAM_VALUE.F_COUNT}
}
