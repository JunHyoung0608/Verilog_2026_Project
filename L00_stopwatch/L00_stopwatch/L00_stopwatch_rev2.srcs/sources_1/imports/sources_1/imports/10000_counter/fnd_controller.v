...
module fnd_controller (
    ...
    wire       w_1khz;
    wire w_dot_onoff, sel_display;

    assign sel_display = (i_write_digit == 2'b10)? 1'b1:
                         (i_write_digit == 2'b01)? 1'b0 :  btn_fnd_sel;
...
module dot_onoff_comp (
    ...
    assign dot_onoff = (msec < 7'd50) ? 1'b1 : 1'b0;
endmodule
