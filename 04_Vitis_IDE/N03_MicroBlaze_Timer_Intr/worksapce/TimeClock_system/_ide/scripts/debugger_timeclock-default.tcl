...
# Path of this script: D:\Verilog_2026_Project\04_Vitis_IDE\N03_MicroBlaze_Timer_Intr\worksapce\TimeClock_system\_ide\scripts\debugger_timeclock-default.tcl
# 
# 
# Usage with xsct:
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow D:/Verilog_2026_Project/04_Vitis_IDE/N03_MicroBlaze_Timer_Intr/worksapce/TimeClock/Debug/TimeClock.elf
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
con
