verdiWindowResize -win $_vdCoverage_1 "830" "370" "1465" "709"
...
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}  {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}   } -type { {Cover Group} {Cover Group}  }
verdiSetActWin -dock widgetDock_<CovDetail>
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}   } -type { {Cover Group}  }
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}   } -type { {Cover Group}  }
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}  {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}   } -type { {Cover Group} {Cover Group}  }
gui_reload_cov 
gui_list_select -id CoverageTable.1 -list covtblFGroupsList { {/$unit::I2C_coverage::I2C_cg}   }
gui_list_expand -id  CoverageTable.1   -list {covtblFGroupsList} {/$unit::I2C_coverage::I2C_cg}
...
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}  {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}   } -type { {Cover Group} {Cover Group}  }
verdiSetActWin -dock widgetDock_<CovDetail>
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}  {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}   } -type { {Cover Group} {Cover Group}  }
gui_list_select -id CovDetail.1 -list covergroup { {$unit::I2C_coverage::I2C_cg.cp_m_tx_data}  {$unit::I2C_coverage::I2C_cg.cp_s_tx_data}   } -type { {Cover Group} {Cover Group}  }
vdCovExit -noprompt
