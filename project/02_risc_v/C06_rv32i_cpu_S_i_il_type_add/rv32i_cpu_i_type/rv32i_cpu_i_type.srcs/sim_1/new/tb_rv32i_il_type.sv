...
module tb_rv32i_il_type ();
    ...
    initial begin
        ...
        `DMEM.dmem[0] = 32'h04_f3_02_f1;
        `DMEM.dmem[1] = 32'h04_f3_f2_01;
        ...
        `INSTR_MEM.rom[4]  = {12'h0, 5'h4, `FNC3_LH,  5'h5, `IL_TYPE};    //LH  x5 = dmem[0+0]
        `INSTR_MEM.rom[5]  = {12'h1, 5'h4, `FNC3_LH,  5'h5, `IL_TYPE};    //LH  x5 = dmem[0+1]
        `INSTR_MEM.rom[6]  = {12'h2, 5'h4, `FNC3_LH,  5'h5, `IL_TYPE};    //LH  x5 = dmem[0+2]
        `INSTR_MEM.rom[7]  = {12'h3, 5'h4, `FNC3_LH,  5'h5, `IL_TYPE};    //LH  x5 = dmem[0+3]
        ...
        `INSTR_MEM.rom[13] = {12'h1, 5'h4, `FNC3_LBU, 5'h5, `IL_TYPE};    //LBU x5 = dmem[0+1]
        `INSTR_MEM.rom[14] = {12'h2, 5'h4, `FNC3_LBU, 5'h5, `IL_TYPE};    //LBU x5 = dmem[0+2]
        `INSTR_MEM.rom[15] = {12'h3, 5'h4, `FNC3_LBU, 5'h5, `IL_TYPE};    //LBU x5 = dmem[0+3]
        `INSTR_MEM.rom[16] = {12'h0, 5'h4, `FNC3_LHU, 5'h5, `IL_TYPE};    //LHU x5 = dmem[0+0]
